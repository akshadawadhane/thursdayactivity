...
public class StringS1 {
	...
	System.out.println("character at index is: "+str.charAt(0));
	     ...
	     System.out.println("Comparing string: "+str.compareTo("Hey hi!"));
	     
		      System.out.println("concat string: "+str.concat("good morning"));
		      
		          System.out.println("index of string: "+str.indexOf("h"));
		          
		             System.out.println("replaceAll string: "+str.replaceAll("h", "H"));
